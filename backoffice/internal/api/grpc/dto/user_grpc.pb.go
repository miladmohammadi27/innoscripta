...
const (
	UserService_CreateUser_FullMethodName    = "/backoffice.v1.UserService/CreateUser"
	UserService_CreateAccount_FullMethodName = "/backoffice.v1.UserService/CreateAccount"
)
...
func (c *userServiceClient) CreateAccount(ctx context.Context, in *CreateAccountReq, opts ...grpc.CallOption) (*CreateAccountRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) CreateAccount(context.Context, *CreateAccountReq) (*CreateAccountRes, error) {
...
func _UserService_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateAccount(ctx, req.(*CreateAccountReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "backoffice.v1.UserService",
